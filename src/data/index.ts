...
export const levels: Level[] = [n5, n4, n5_2012, irodoriStarter, irodoriElementary1, irodoriElementary2, irodoriPreIntermediate, irodoriTips]

export const courses: Course[] = [
  { id: 'jlpt', titlePt: 'JLPT', taglinePt: 'Exame de proficiência (N5/N4)', levels: [n5, n4, n5_2012] },
