...
const L11_SCRIPTS: Record<string, ScriptItem[]> = {
  '11-03': [
    {
      label: '会話 — 洋服売り場（セーター）(11-03)',
      setupJa: '{客|きゃく}が{洋服|ようふく}{売|う}り{場|ば}でセーターを{選|えら}び、{店員|てんいん}に{試着|しちゃく}・サイズ・{色|いろ}を{聞|き}いています。',
      setupPt: 'O cliente escolhe um suéter na loja de roupas e pergunta à vendedora sobre prova, tamanho e cor.',
      lines: [
        { speaker: '店員', ja: 'いらっしゃいませ。どうぞ、ごゆっくりごらんください。ただいま、{全品|ぜんぴん}10％オフです。', pt: 'Bem-vindo(a). Fique à vontade para olhar com calma. No momento, todos os itens estão com 10% de desconto.' },
        { speaker: '客', ja: 'すみません。このセーター、Mサイズ、ありますか？', pt: 'Com licença. Este suéter, tem no tamanho M?' },
        { speaker: '店員', ja: 'はい。こちらにございます。よろしければ、ご{試着|しちゃく}もできますよ。', pt: 'Sim. Está aqui. Se quiser, também pode experimentar.' },
        { speaker: '客', ja: 'じゃあ、{着|き}てみてもいいですか？', pt: 'Então, posso experimentar?' },
        { speaker: '店員', ja: 'かしこまりました。{試着室|しちゃくしつ}へご{案内|あんない}いたします。', pt: 'Pois não. Vou levá-lo(a) ao provador.' },
        { speaker: '客', ja: 'すみません、ほかの{色|いろ}、ありませんか？　この{色|いろ}はちょっと{派手|はで}すぎます。', pt: 'Com licença, não tem outra cor? Esta cor é um pouco chamativa demais.' },
        { speaker: '店員', ja: '{黒|くろ}、グレー、ベージュがございますが……。', pt: 'Temos em preto, cinza e bege…' },
        { speaker: '客', ja: 'じゃあ、その3つ、{試着|しちゃく}してもいいですか？', pt: 'Então, posso experimentar essas três?' },
        { speaker: '店員', ja: 'かしこまりました。', pt: 'Pois não.' },
        { speaker: '客', ja: 'あと、もうちょっと{大|おお}きいの、ありますか？', pt: 'E também, tem um pouco maior?' },
        { speaker: '店員', ja: 'それではLサイズ、お{持|も}ちします。{少々|しょうしょう}お{待|ま}ちください。', pt: 'Então vou trazer o tamanho G. Aguarde um momento.' },
        { speaker: '店員', ja: 'お{疲|つか}れさまでした。いかがでしたか？', pt: 'Pronto. Que tal ficou?' },
        { speaker: '客', ja: 'このベージュにします。', pt: 'Vou ficar com este bege.' },
        { speaker: '店員', ja: 'ありがとうございます。ほかは、よろしいですか？', pt: 'Obrigada. Mais alguma coisa?' },
        { speaker: '客', ja: 'だいじょうぶです。', pt: 'Não, está bom.' },
        { speaker: '店員', ja: 'それでは、お{会計|かいけい}、こちらへどうぞ。', pt: 'Então, o caixa é por aqui, por favor.' },
      ],
    },
  ],
...
const L12_SCRIPTS: Record<string, ScriptItem[]> = {
  '12-03': [
    {
      label: '① イヤホン (12-03)',
      setupJa: '{買|か}いたい・{売|う}りたい{電気製品|でんきせいひん}について、ほかの{人|ひと}に{相談|そうだん}しています。① イヤホン。',
      setupPt: 'Consultando outra pessoa sobre um eletrônico que quer comprar/vender. ① fones de ouvido.',
      lines: [
        { speaker: 'A', ja: '{田山|たやま}さん、{新|あたら}しいイヤホンがほしいんですけど、{田山|たやま}さんはどんなイヤホン、{使|つか}ってますか？', pt: 'Tayama, quero comprar fones de ouvido novos; que tipo de fone você usa?' },
        { speaker: 'B', ja: 'あー、おれはこれ。「BOSAN」ってメーカーのワイヤレス。2{年前|ねんまえ}{買|か}ったんだけど、いいよ。デザインが{気|き}に{入|い}って、これにしたんだ。ちょっと{高|たか}かったけど、{音|おと}もいいし、{耳|みみ}も{痛|いた}くならないし……。', pt: 'Ah, eu uso este. É o sem fio da marca «BOSAN». Comprei há 2 anos, é bom. Gostei do design e escolhi este. Foi um pouco caro, mas o som é ótimo e não machuca o ouvido…' },
        { speaker: 'A', ja: 'へー。', pt: 'Nossa.' },
        { speaker: 'B', ja: 'でも、{今|いま}は{新|あたら}しいモデルが{出|で}てると{思|おも}うから、{一度|いちど}お{店|みせ}に{行|い}って、{見|み}てみたら？', pt: 'Mas acho que agora já saiu um modelo novo, então que tal dar uma passada na loja e ver?' },
        { speaker: 'A', ja: 'はい、そうします。', pt: 'Sim, vou fazer isso.' },
      ],
    },
  ],
  '12-04': [
    {
      label: '② パソコン (12-04)',
      setupPt: '② computador (comprar pela internet).',
      lines: [
        { speaker: 'A', ja: '{木村|きむら}さん、ネットでパソコン{買|か}ったことありますか？', pt: 'Kimura, você já comprou computador pela internet?' },
        { speaker: 'B', ja: 'あー、{前|まえ}に{買|か}ったことありますよ。「ヨツジマネット」っていうところで。', pt: 'Ah, já comprei uma vez. Num lugar chamado «Yotsujima Net».' },
        { speaker: 'A', ja: 'そうなんですか？　どうでしたか？', pt: 'É mesmo? Como foi?' },
        { speaker: 'B', ja: 'そうですね。お{店|みせ}の{人|ひと}に{相談|そうだん}できないので、ちょっと{心配|しんぱい}でしたけど、{安|やす}くて、よかったです。{手元|てもと}に{届|とど}くまで、2{日|ふつか}しかかからなかったし、{送料|そうりょう}も{無料|むりょう}でしたし。', pt: 'Bom, como não dá para consultar um vendedor, fiquei um pouco apreensivo, mas foi barato, valeu a pena. Até chegar às minhas mãos levou só 2 dias, e o frete também foi grátis.' },
        { speaker: 'A', ja: 'へー、{無料|むりょう}。いいですね。「ヨツジマネット」ですね。{見|み}てみます。', pt: 'Nossa, frete grátis. Que bom. «Yotsujima Net», né. Vou dar uma olhada.' },
      ],
    },
  ],
  '12-05': [
    {
      label: '③ 電子レンジ (12-05)',
      setupPt: '③ micro-ondas (onde comprar).',
      lines: [
        { speaker: 'A', ja: '{今井|いまい}さん、{電子|でんし}レンジがほしいんですけど、どこで{買|か}ったらいいですか？', pt: 'Imai, quero um micro-ondas; onde é bom comprar?' },
        { speaker: 'B', ja: '{新|あたら}しくできた{電気屋|でんきや}さん{行|い}った？　{国道|こくどう}{沿|ぞ}いにできた。', pt: 'Você já foi naquela loja de eletrônicos que abriu há pouco? A que abriu à beira da rodovia.' },
        { speaker: 'A', ja: 'あー、「J’s デンキ」ですか。まだです。', pt: 'Ah, a «J’s Denki»? Ainda não.' },
        { speaker: 'B', ja: 'あそこ、いいよ。{大|おお}きい{店|みせ}だから{商品|しょうひん}も{多|おお}いし、{店員|てんいん}も{親切|しんせつ}だし。', pt: 'Aquela é boa. Como é uma loja grande, tem bastante produto, e os vendedores são atenciosos.' },
        { speaker: 'A', ja: 'そうなんですか。', pt: 'Ah, é?' },
        { speaker: 'B', ja: '{今|いま}、{開店|かいてん}セールやってて、{安|やす}く{買|か}えると{思|おも}うよ。', pt: 'Agora está rolando a liquidação de inauguração, acho que dá para comprar barato.' },
        { speaker: 'A', ja: 'でも、{行|い}くのがちょっと{大変|たいへん}そうですね。', pt: 'Mas ir até lá parece um pouco trabalhoso.' },
        { speaker: 'B', ja: '{行|い}くんなら、{車|くるま}、{出|だ}してもいいよ。', pt: 'Se você for, posso te levar de carro.' },
        { speaker: 'A', ja: 'えー！　ありがとうございます。', pt: 'Sério?! Muito obrigado.' },
      ],
    },
  ],
  '12-06': [
    {
      label: '④ 扇風機 (12-06)',
      setupPt: '④ ventilador (vender o antigo).',
      lines: [
        { speaker: 'A', ja: 'エニさん、{扇風機|せんぷうき}、{持|も}ってますか？', pt: 'Eni, você tem ventilador?' },
        { speaker: 'B', ja: '{扇風機|せんぷうき}？　ありますけど、どうしてですか？', pt: 'Ventilador? Tenho, mas por quê?' },
        { speaker: 'A', ja: 'うん。{新|あたら}しいのを{買|か}ったから、{古|ふる}いのをだれかにあげたいと{思|おも}って……。', pt: 'É que comprei um novo, então queria dar o antigo para alguém…' },
        { speaker: 'B', ja: 'だったら、ネットで{売|う}ったらどうですか？　「マルフリ」とか。', pt: 'Nesse caso, que tal vender pela internet? No «Marufuri», por exemplo.' },
        { speaker: 'A', ja: 'あー、フリマサイトですか？', pt: 'Ah, num site de brechó?' },
        { speaker: 'B', ja: 'そうそう。ほしい{人|ひと}がすぐ{見|み}つかるし、けっこう{高|たか}く{売|う}れるんですよ。', pt: 'Isso. Logo aparece alguém interessado, e dá para vender por um preço até bom.' },
        { speaker: 'A', ja: 'そうなんですか。', pt: 'Ah, é?' },
        { speaker: 'B', ja: '{手続|てつづ}きも{簡単|かんたん}だから、だれでもできますよ。', pt: 'O processo também é simples, qualquer um consegue.' },
        { speaker: 'A', ja: 'へー。じゃあ、{見|み}てみます。', pt: 'Nossa. Então vou dar uma olhada.' },
      ],
    },
  ],
}
...
const L13_SCRIPTS: Record<string, ScriptItem[]> = {
  '13-03': [
    {
      label: '会話 — 文化施設「さくらトピア」の案内 (13-03)',
      setupJa: 'リックさんが、{同僚|どうりょう}の{皆川|みながわ}さんに、{市|し}の{文化|ぶんか}{施設|しせつ}「さくらトピア」を{案内|あんない}してもらっています。',
      setupPt: 'Rick é guiado pela colega Minagawa pelo centro cultural municipal «Sakura Topia».',
      lines: [
        { speaker: 'リック', ja: 'ここは、{大|おお}きくてきれいな{建物|たてもの}ですね。', pt: 'Este é um prédio grande e bonito, não é?' },
        { speaker: '皆川', ja: 'ええ。この{建物|たてもの}は、{市|し}の{文化|ぶんか}{施設|しせつ}で、2{年前|ねんまえ}に{建|た}てられたんです。', pt: 'Sim. Este prédio é uma instalação cultural do município, foi construído há 2 anos.' },
        { speaker: 'リック', ja: 'まだ{新|あたら}しいですね。ここには{何|なに}があるんですか？', pt: 'Ainda é novo, então. O que tem aqui?' },
        { speaker: '皆川', ja: 'メインは、さくらホールですね。{成人式|せいじんしき}とかの{市|し}の{行事|ぎょうじ}に{使|つか}われてますし、{音楽|おんがく}のコンサートもやってますよ。', pt: 'O principal é o Salão Sakura. É usado em eventos do município, como a cerimônia da maioridade, e também há concertos de música.' },
        { speaker: 'リック', ja: 'へー。', pt: 'Nossa.' },
        { speaker: '皆川', ja: '{下|した}には、インフォメーションコーナーもあります。{市内|しない}のいろいろな{施設|しせつ}や{観光地|かんこうち}のパンフレットが{置|お}いてあるし、ネットが{使|つか}えるPCをただで{自由|じゆう}に{使|つか}うこともできますよ。', pt: 'Lá embaixo também tem um balcão de informações. Há folhetos de vários locais e pontos turísticos da cidade, e dá para usar de graça e à vontade um PC com internet.' },
        { speaker: 'リック', ja: 'それは{便利|べんり}そうですね。', pt: 'Isso parece bem prático.' },
        { speaker: '皆川', ja: 'あと、{図書館|としょかん}もあって、けっこう{大|おお}きくてきれいで、{私|わたし}もよく{使|つか}ってます。', pt: 'Também tem uma biblioteca, bem grande e bonita; eu uso bastante.' },
        { speaker: 'リック', ja: '{外国語|がいこくご}の{本|ほん}もありますか？', pt: 'Tem livros em língua estrangeira também?' },
        { speaker: '皆川', ja: 'あると{思|おも}いますよ。あと、{本|ほん}だけじゃなくて、CDとか、DVDもただで{借|か}りられます。', pt: 'Acho que sim. E não só livros — CDs e DVDs também podem ser emprestados de graça.' },
        { speaker: 'リック', ja: 'DVDもただですか。それはいいですね。', pt: 'DVDs também de graça? Que ótimo.' },
        { speaker: '皆川', ja: 'ほかには……{民俗|みんぞく}{資料館|しりょうかん}もあります。{昔|むかし}、{使|つか}われた{道具|どうぐ}とか、いろいろな{資料|しりょう}を{展示|てんじ}してあります。この{町|まち}の{歴史|れきし}や{文化|ぶんか}に{興味|きょうみ}があったら、ぜひ{行|い}ってみてください。', pt: 'Além disso… também há um museu de cultura popular. Há vários acervos expostos, como utensílios usados antigamente. Se você se interessa pela história e cultura desta cidade, vale a pena visitar.' },
        { speaker: 'リック', ja: 'おもしろそうですね。{今度|こんど}、{休|やす}みの{日|ひ}にまた{来|き}てみます。', pt: 'Parece interessante. Vou voltar num dia de folga.' },
      ],
    },
  ],
  // 2. はじめて利用するんですが… (公共施設の利用説明)
  '13-07': [
    {
      label: '① スポーツジムの受付 (13-07)',
      setupJa: '{公共|こうきょう}{施設|しせつ}を、はじめて{利用|りよう}する{人|ひと}が、{利用方法|りようほうほう}の{説明|せつめい}を{聞|き}いています。① スポーツジム。',
      setupPt: 'Quem vai usar uma instalação pública pela primeira vez ouve a explicação de como usar. ① academia.',
      lines: [
        { speaker: '客', ja: 'すみません、はじめて{利用|りよう}するんですが……。', pt: 'Com licença, é a primeira vez que vou usar…' },
        { speaker: '係', ja: 'はい。ジムのご{利用|りよう}ですね。', pt: 'Sim. É para usar a academia, certo?' },
        { speaker: '客', ja: 'はい。', pt: 'Sim.' },
        { speaker: '係', ja: '{料金|りょうきん}は1{人|ひとり}560{円|えん}で3{時間|じかん}までです。3{時間|じかん}{以上|いじょう}のご{利用|りよう}は、{延長|えんちょう}{料金|りょうきん}が30{分|ぷん}につき150{円|えん}かかります。ご{了承|りょうしょう}ください。', pt: 'A tarifa é 560 ienes por pessoa, até 3 horas. Acima de 3 horas, há uma taxa de prorrogação de 150 ienes a cada 30 minutos. Pedimos sua compreensão.' },
        { speaker: '客', ja: 'わかりました。', pt: 'Entendi.' },
        { speaker: '係', ja: 'それでは、そこの{階段|かいだん}を{下|お}りたところに{更衣室|こういしつ}がありますので、そこで{着替|きが}えてください。それから、ジムでは、{室内用|しつないよう}のシューズをはいてください。お{持|も}ちですか？', pt: 'Então, descendo aquela escada há um vestiário; troque-se lá. Além disso, na academia, use tênis de uso interno. Você tem?' },
        { speaker: '客', ja: 'はい、あります。', pt: 'Sim, tenho.' },
        { speaker: '係', ja: 'それから、はじめて{利用|りよう}するときは、マシンの{使|つか}い{方|かた}など、トレーナーから30{分|ぷん}ほどのオリエンテーションを{受|う}けていただきます。トレーナーは{中|なか}にいますので、{声|こえ}をかけてください。', pt: 'E, na primeira vez, você passa por uma orientação de cerca de 30 minutos com o instrutor, sobre como usar os aparelhos etc. O instrutor está lá dentro, então é só chamá-lo.' },
        { speaker: '客', ja: 'わかりました。', pt: 'Entendi.' },
      ],
    },
  ],
  '13-08': [
    {
      label: '② 博物館のチケット売り場 (13-08)',
      setupPt: '② bilheteria do museu.',
      lines: [
        { speaker: '客', ja: 'えっと、{博物館|はくぶつかん}、{大人|おとな}1{人|ひとり}、お{願|ねが}いします。', pt: 'Hmm, museu, uma entrada de adulto, por favor.' },
        { speaker: '係', ja: '{博物館|はくぶつかん}だけでよろしいですか？　{美術館|びじゅつかん}とセットでご{利用|りよう}ですか？', pt: 'Só o museu está bom? Ou quer o combo com o museu de arte?' },
        { speaker: '客', ja: 'え？　えっと、{美術館|びじゅつかん}には{何|なに}がありますか？', pt: 'Hã? Hmm, o que tem no museu de arte?' },
        { speaker: '係', ja: 'さまざまな{絵|え}や{彫刻|ちょうこく}がありますが、{特|とく}に、この{町|まち}{出身|しゅっしん}の{画家|がか}、{山田|やまだ}{一町|いっちょう}の{作品|さくひん}を{中心|ちゅうしん}に{展示|てんじ}されています。このカレンダーが、{山田|やまだ}の{絵|え}になります。', pt: 'Há diversos quadros e esculturas, mas a exposição é centrada nas obras de Yamada Itchō, um pintor natural desta cidade. Este calendário é uma pintura do Yamada.' },
        { speaker: '客', ja: 'ああ、いいですね。それでは、{美術館|びじゅつかん}とのセットでお{願|ねが}いします。', pt: 'Ah, que bom. Então quero o combo com o museu de arte, por favor.' },
        { speaker: '係', ja: 'はい、それでは、セット{券|けん}、600{円|えん}になります。', pt: 'Certo, então o bilhete combinado fica 600 ienes.' },
        { speaker: '客', ja: 'あ、あと、{博物館|はくぶつかん}の{中|なか}で、{写真|しゃしん}を{撮|と}ってもいいですか？', pt: 'Ah, e mais uma coisa: posso tirar fotos dentro do museu?' },
        { speaker: '係', ja: 'はい、{博物館|はくぶつかん}での{撮影|さつえい}はだいじょうぶですが、フラッシュは{使|つか}わないでください。', pt: 'Sim, pode fotografar no museu, mas não use o flash.' },
        { speaker: '客', ja: 'わかりました。ありがとうございます。', pt: 'Entendi. Obrigado.' },
      ],
    },
  ],
  '13-09': [
    {
      label: '③ 入浴施設の受付 (13-09)',
      setupPt: '③ recepção da casa de banho.',
      lines: [
        { speaker: '客', ja: 'すみません、お{風呂|ふろ}に{入|はい}りたいんですが……。', pt: 'Com licença, eu queria tomar banho…' },
        { speaker: '係', ja: 'それでは、そちらの{券売機|けんばいき}でチケットを{買|か}ってください。お1{人|ひとり}400{円|えん}です。', pt: 'Então compre um bilhete naquela máquina ali. São 400 ienes por pessoa.' },
        { speaker: '客', ja: 'はい。あのう、すみません、タオルやシャンプーは、ついていますか？', pt: 'Sim. Ahn, com licença, toalha e xampu estão inclusos?' },
        { speaker: '係', ja: 'シャンプーは、お{風呂|ふろ}にあります。タオルは、こちらで1{枚|まい}150{円|えん}で{販売|はんばい}しています。タオルも{券売機|けんばいき}でチケットを{買|か}ってください。', pt: 'O xampu fica no banho. A toalha vendemos aqui, a 150 ienes cada. Compre o bilhete da toalha também na máquina.' },
        { speaker: '客', ja: 'わかりました。（チケットを{買|か}う）じゃあ、これ、{大人|おとな}1{枚|まい}と、タオルのチケットです。', pt: 'Entendi. (compra o bilhete) Então aqui: uma entrada de adulto e o bilhete da toalha.' },
        { speaker: '係', ja: 'ありがとうございます。こちら、タオルです。どうぞ。お{風呂|ふろ}はあちらです。{休憩室|きゅうけいしつ}は2{階|かい}です。', pt: 'Obrigado. Aqui está a toalha. O banho é por ali. A sala de descanso fica no 2º andar.' },
        { speaker: '客', ja: '{休憩室|きゅうけいしつ}は、{料金|りょうきん}がかかりますか？', pt: 'A sala de descanso tem cobrança?' },
        { speaker: '係', ja: 'いえ、{無料|むりょう}でご{利用|りよう}いただけます。', pt: 'Não, é de uso gratuito.' },
        { speaker: '客', ja: 'わかりました。ありがとうございます。', pt: 'Entendi. Obrigado.' },
        { speaker: '係', ja: 'どうぞ、ごゆっくり。', pt: 'Aproveite com calma.' },
      ],
    },
  ],
  '13-10': [
    {
      label: '④ 図書館の利用者カード (13-10)',
      setupPt: '④ cartão de usuário da biblioteca (internet/impressora).',
      lines: [
        { speaker: '客', ja: 'あのう、すみません。こちらで、インターネットとプリンターが{無料|むりょう}で{使|つか}えると{聞|き}きました。', pt: 'Ahn, com licença. Ouvi que aqui dá para usar internet e impressora de graça.' },
        { speaker: '係', ja: 'はい。こちらは、はじめてですね？', pt: 'Sim. É a sua primeira vez aqui, certo?' },
        { speaker: '客', ja: 'はい、はじめてです。', pt: 'Sim, é a primeira vez.' },
        { speaker: '係', ja: 'それでは、まず{利用者|りようしゃ}カードを{作|つく}りますので、こちらの{書類|しょるい}に、お{名前|なまえ}や{住所|じゅうしょ}、{電話番号|でんわばんごう}などを{書|か}いてください。', pt: 'Então, primeiro vamos fazer um cartão de usuário; escreva neste formulário seu nome, endereço, telefone etc.' },
        { speaker: '客', ja: 'はい、わかりました。……これでいいですか？', pt: 'Sim, entendi. …Assim está bom?' },
        { speaker: '係', ja: 'はい、それでは、{少々|しょうしょう}お{待|ま}ちください。……お{待|ま}たせしました。こちらが{利用者|りようしゃ}カードになりますので、{次回|じかい}からは、これをお{持|も}ちください。', pt: 'Sim. Então aguarde um momento. …Desculpe a espera. Este é o seu cartão de usuário; da próxima vez, traga-o.' },
        { speaker: '客', ja: 'はい。', pt: 'Sim.' },
        { speaker: '係', ja: 'では、{空|あ}いているところを、ご{自由|じゆう}にお{使|つか}いください。1{人|ひとり}60{分|ぷん}まででお{願|ねが}いします。', pt: 'Então, use à vontade qualquer lugar que estiver livre. Por favor, até 60 minutos por pessoa.' },
        { speaker: '客', ja: '60{分|ぷん}ですね。', pt: '60 minutos, então.' },
        { speaker: '係', ja: 'それから、プリントアウトは{無料|むりょう}ですが、1{人|ひとり}10{枚|まい}までとなっています。', pt: 'E a impressão é gratuita, mas até 10 folhas por pessoa.' },
        { speaker: '客', ja: 'わかりました。', pt: 'Entendi.' },
      ],
    },
  ],
...
const L14_SCRIPTS: Record<string, ScriptItem[]> = {
  '14-02': [
    {
      label: '会話1 — クリーニング店 (14-02)',
      setupJa: 'いろいろな{店|みせ}で、お{店|みせ}の{人|ひと}と{話|はな}しています。① シミのついたズボンをクリーニング{店|てん}に{持|も}って{来|き}ました。',
      setupPt: 'Falando com funcionários em vários estabelecimentos. ① levou à tinturaria uma calça manchada.',
      lines: [
        { speaker: '店員', ja: 'いらっしゃいませ。', pt: 'Bem-vindo(a).' },
        { speaker: '客', ja: 'すみません、クリーニングをお{願|ねが}いします。', pt: 'Com licença, queria deixar para lavar.' },
        { speaker: '店員', ja: 'はい、こちらですね。ズボンが1{点|てん}でよろしいですか？', pt: 'Pois não, é isto aqui. Só uma calça, certo?' },
        { speaker: '客', ja: 'はい。あの、このズボン、ここが{汚|よご}れてしまったんですが、きれいになりますか？', pt: 'Sim. Ahn, esta calça sujou aqui; será que sai?' },
        { speaker: '店員', ja: 'あー、けっこう{大|おお}きなシミですねえ。こちらは{何|なん}のシミですか？', pt: 'Ah, é uma mancha bem grande. De que é essa mancha?' },
        { speaker: '客', ja: 'カレーです。', pt: 'De curry.' },
        { speaker: '店員', ja: 'カレーのシミは、{落|お}ちにくいんですよ。シミ{抜|ぬ}きをしますか？　{別料金|べつりょうきん}ですが。', pt: 'Mancha de curry é difícil de sair. Quer que façamos a remoção de mancha? É cobrança à parte.' },
        { speaker: '客', ja: 'シミ{抜|ぬ}き……いくらですか？', pt: 'Remoção de mancha… quanto fica?' },
        { speaker: '店員', ja: 'クリーニング{代|だい}{込|こ}みで、1,500{円|えん}になります。', pt: 'Incluindo a lavagem, fica 1.500 ienes.' },
        { speaker: '客', ja: 'わかりました。じゃあ、それをお{願|ねが}いします。', pt: 'Entendi. Então faça isso, por favor.' },
        { speaker: '店員', ja: 'お{渡|わた}しまでに2{週間|しゅうかん}ほどかかりますが、よろしいですか？', pt: 'Leva cerca de 2 semanas para ficar pronto; tudo bem?' },
        { speaker: '客', ja: 'はい、だいじょうぶです。', pt: 'Sim, tudo bem.' },
      ],
    },
  ],
  '14-03': [
    {
      label: '会話2 — 自転車店（空気入れ）(14-03)',
      setupJa: '② {自転車|じてんしゃ}の{空気|くうき}を{入|い}れに、{自転車店|じてんしゃてん}に{来|き}ました。',
      setupPt: '② foi à bicicletaria encher o pneu de ar.',
      lines: [
        { speaker: '客', ja: 'すみません、{自転車|じてんしゃ}の{空気|くうき}を{入|い}れたいんですが……。', pt: 'Com licença, eu queria encher o pneu da bicicleta…' },
        { speaker: '店員', ja: 'ああ、{空気|くうき}？　{空気入|くうきい}れはそこに{置|お}いてあるよ。', pt: 'Ah, ar? A bomba de ar está ali.' },
        { speaker: '客', ja: '{使|つか}ってもいいですか？', pt: 'Posso usar?' },
        { speaker: '店員', ja: 'うん、{自分|じぶん}で{入|い}れてくれる？', pt: 'Pode. Você mesmo enche, tá?' },
        { speaker: '客', ja: 'はい……あれ、すみません。{使|つか}い{方|かた}が、よくわからないんですが……。{空気|くうき}が{入|はい}らないんです。', pt: 'Sim… Ué, desculpe. Não entendi muito bem como usar… O ar não entra.' },
        { speaker: '店員', ja: 'どれどれ。ああ、{空気|くうき}を{入|い}れるときは、タイヤのキャップをはずさなきゃ。ここに、こうはさんで、あとは、{空気|くうき}を{入|い}れて、{終|お}わったらキャップをかぶせればいいよ。', pt: 'Deixa eu ver. Ah, para encher o ar, tem de tirar a tampinha do pneu. Encaixa aqui assim, depois enche o ar e, no fim, é só recolocar a tampinha.' },
        { speaker: '客', ja: 'わかりました。……ありがとうございました。{終|お}わりました。いくらですか？', pt: 'Entendi. …Obrigado. Terminei. Quanto fica?' },
        { speaker: '店員', ja: 'お{金|かね}はいいよ。', pt: 'Não precisa pagar.' },
        { speaker: '客', ja: 'え、いいんですか？　ありがとうございます。', pt: 'Hã, pode ser? Muito obrigado.' },
        { speaker: '店員', ja: 'ついでに、{油|あぶら}も{差|さ}して{行|い}く？', pt: 'Já que está aqui, quer que eu passe um óleo também?' },
        { speaker: '客', ja: 'あ、はい。ありがとうございます。', pt: 'Ah, sim. Obrigado.' },
      ],
    },
  ],
  '14-04': [
    {
      label: '会話3 — 宅配便 (14-04)',
      setupJa: '③ {宅配便|たくはいびん}で{荷物|にもつ}を{送|おく}りに{来|き}ました。',
      setupPt: '③ foi enviar uma encomenda pelo serviço de entrega.',
      lines: [
        { speaker: '客', ja: 'すみません、{宅配便|たくはいびん}を{送|おく}りたいんですが……。', pt: 'Com licença, eu queria enviar uma encomenda…' },
        { speaker: '店員', ja: '{宅配便|たくはいびん}ですね。{着払|ちゃくばら}いと{元払|もとばら}いは、どちらになりますか？', pt: 'Encomenda, certo. Vai ser com pagamento na entrega (chakubarai) ou pago agora pelo remetente (motobarai)?' },
        { speaker: '客', ja: 'え？　すみません、わかりません……。', pt: 'Hã? Desculpe, não sei…' },
        { speaker: '店員', ja: '{元払|もとばら}いは、{今|いま}ここでお{金|かね}を{払|はら}います。{着払|ちゃくばら}いは、{受|う}け{取|と}る{人|ひと}がお{金|かね}を{払|はら}います。', pt: 'No motobarai, você paga aqui agora. No chakubarai, quem recebe é que paga.' },
        { speaker: '客', ja: 'あ、{今|いま}お{金|かね}を{払|はら}います。', pt: 'Ah, eu pago agora.' },
        { speaker: '店員', ja: '{元払|もとばら}いですね。それでは、こちらの{伝票|でんぴょう}をお{書|か}きください。', pt: 'Motobarai, então. Por favor, preencha esta guia.' },
        { speaker: '客', ja: '……これでいいですか？', pt: '…Assim está bom?' },
        { speaker: '店員', ja: 'はい、お{預|あず}かりします。お{届|とど}けの{日時|にちじ}の{指定|してい}はありますか？　{今|いま}からですと、{明日|あした}10{日|か}の{午前中|ごぜんちゅう}が{最|もっと}も{早|はや}いお{届|とど}けになりますが。', pt: 'Certo, está recebido. Há alguma data/hora de entrega preferida? A partir de agora, o mais cedo seria amanhã, dia 10, pela manhã.' },
        { speaker: '客', ja: 'じゃあ、{明日|あした}の{夜|よる}でお{願|ねが}いします。', pt: 'Então pode ser amanhã à noite.' },
        { speaker: '店員', ja: '19{時|じ}から21{時|じ}でよろしいですか？', pt: 'Entre 19h e 21h está bom?' },
        { speaker: '客', ja: 'はい。', pt: 'Sim.' },
        { speaker: '店員', ja: 'それでは……{料金|りょうきん}、1,260{円|えん}になります。', pt: 'Então… a tarifa fica 1.260 ienes.' },
      ],
    },
  ],
  '14-05': [
    {
      label: '会話4 — 銀行のATM (14-05)',
      setupJa: '④ {銀行|ぎんこう}のATMでお{金|かね}をおろそうとしています。',
      setupPt: '④ está tentando sacar dinheiro num caixa eletrônico (ATM) do banco.',
      lines: [
        { speaker: '客', ja: 'すみません。', pt: 'Com licença.' },
        { speaker: '銀行員', ja: 'はい、お{客様|きゃくさま}、どうなさいましたか？', pt: 'Pois não, senhor(a), o que houve?' },
        { speaker: '客', ja: 'あのう、このATMでお{金|かね}をおろしたいんですが、{使|つか}い{方|かた}がよくわからなくて。', pt: 'Ahn, eu queria sacar dinheiro neste caixa, mas não sei bem como usar.' },
        { speaker: '銀行員', ja: 'こちらのATMは、{英語|えいご}のご{案内|あんない}も{表示|ひょうじ}されますが……。', pt: 'Este caixa também exibe as instruções em inglês…' },
        { speaker: '客', ja: 'あ、{私|わたし}は{英語|えいご}はよくわからないので、{日本語|にほんご}で{教|おし}えてもらえませんか？', pt: 'Ah, eu não entendo bem inglês; pode me explicar em japonês?' },
        { speaker: '銀行員', ja: 'かしこまりました。それでは、まず、こちらにキャッシュカードを{入|い}れてください。', pt: 'Pois não. Então, primeiro insira o cartão aqui.' },
        { speaker: '客', ja: 'ここですね？', pt: 'Aqui, certo?' },
        { speaker: '銀行員', ja: 'はい。お{金|かね}をおろすのでしたら、この「お{引|ひ}き{出|だ}し」のボタンを{押|お}してください。', pt: 'Sim. Se for sacar, aperte este botão «saque».' },
        { speaker: '客', ja: 'はい。', pt: 'Sim.' },
        { speaker: '銀行員', ja: '{次|つぎ}に、{暗証番号|あんしょうばんごう}を{入力|にゅうりょく}してください。4{桁|けた}の{数字|すうじ}です。おわかりですか？', pt: 'Em seguida, digite a senha. São 4 dígitos. Você sabe?' },
        { speaker: '客', ja: 'はい、わかります。', pt: 'Sim, sei.' },
        { speaker: '銀行員', ja: 'そうしたら、{暗証番号|あんしょうばんごう}を{入|い}れて、{緑色|みどりいろ}の「OK」ボタンを{押|お}してください。', pt: 'Então digite a senha e aperte o botão verde «OK».' },
        { speaker: '客', ja: 'はい、{入|い}れました。', pt: 'Pronto, digitei.' },
        { speaker: '銀行員', ja: '{次|つぎ}に、{金額|きんがく}を{入力|にゅうりょく}します。おろしたい{金額|きんがく}を{入|い}れて、また{緑|みどり}のボタンを{押|お}してください。', pt: 'Agora digite o valor. Coloque a quantia que quer sacar e aperte de novo o botão verde.' },
        { speaker: '客', ja: 'はい、{押|お}しました。', pt: 'Pronto, apertei.' },
        { speaker: '銀行員', ja: 'すべて{一万円札|いちまんえんさつ}でよろしいですか？　それとも、{一部|いちぶ}を{千円札|せんえんさつ}に{両替|りょうがえ}なさいますか？　{両替|りょうがえ}が{必要|ひつよう}なければ、こちらの{左|ひだり}のボタンを{押|お}してください。{両替|りょうがえ}する{場合|ばあい}は、{右|みぎ}のボタンを{押|お}してください。', pt: 'Pode ser tudo em notas de 10 mil ienes? Ou prefere trocar parte por notas de mil ienes? Se não precisar trocar, aperte o botão da esquerda. Se quiser trocar, aperte o da direita.' },
        { speaker: '客', ja: 'はい。', pt: 'Sim.' },
        { speaker: '銀行員', ja: 'ご{利用明細|りようめいさい}、レシートは{必要|ひつよう}ですか？', pt: 'Você quer o comprovante/recibo?' },
        { speaker: '客', ja: 'えーと、いらないです。', pt: 'Hmm, não preciso.' },
        { speaker: '銀行員', ja: 'それでは、「いいえ」のボタンを{押|お}して、お{待|ま}ちください。', pt: 'Então aperte o botão «não» e aguarde.' },
        { speaker: '機械', ja: 'カードをお{取|と}りください。{紙幣|しへい}をお{取|と}りください。ご{利用|りよう}ありがとうございました。', pt: 'Retire o cartão. Retire as cédulas. Obrigado por usar nossos serviços.' },
        { speaker: '客', ja: 'おろせました！　ありがとうございました。', pt: 'Consegui sacar! Muito obrigado.' },
        { speaker: '銀行員', ja: 'ご{利用|りよう}ありがとうございました。', pt: 'Obrigado por usar nossos serviços.' },
      ],
    },
  ],
  '14-07': [
  ...
  '14-13': [
    {
      label: '会話 — 外国の方のためのサービス (14-13)',
      setupJa: 'ディアンティさんが、{担当|たんとう}の{人|ひと}に、{外国|がいこく}の{方|かた}{向|む}けのサービスについて{聞|き}いています。',
      setupPt: 'Dianti pergunta a uma atendente sobre os serviços oferecidos a estrangeiros.',
      lines: [
        { speaker: 'ディアンティ', ja: 'こんにちは。', pt: 'Olá.' },
        { speaker: '担当の人', ja: 'はい、こんにちは。', pt: 'Olá, pois não.' },
        { speaker: 'ディアンティ', ja: 'すみません、ちょっと{質問|しつもん}があるんですが……。', pt: 'Com licença, eu tenho uma pergunta…' },
        { speaker: '担当の人', ja: 'はい。{何|なん}ですか？', pt: 'Sim. O que é?' },
        { speaker: 'ディアンティ', ja: 'えーと、ここで、{外国語|がいこくご}で{無料|むりょう}で{相談|そうだん}ができると{聞|き}きました。インドネシア{語|ご}の{相談|そうだん}もできますか？', pt: 'Hmm, ouvi que aqui dá para fazer consultas gratuitas em língua estrangeira. Dá para consultar em indonésio também?' },
        { speaker: '担当の人', ja: 'はい、できますよ。でも、{外国語|がいこくご}の{相談|そうだん}は、{曜日|ようび}と{時間|じかん}が{決|き}まっています。インドネシア{語|ご}は、{毎週|まいしゅう}{火曜日|かようび}です。', pt: 'Sim, dá. Mas as consultas em língua estrangeira têm dia e horário fixos. O indonésio é toda terça-feira.' },
        { speaker: 'ディアンティ', ja: '{火曜日|かようび}……わかりました。{仕事|しごと}やビザのことで{相談|そうだん}がしたいんですが、できますか？', pt: 'Terça-feira… entendi. Eu queria consultar sobre trabalho e visto; dá para fazer?' },
        { speaker: '担当の人', ja: 'だいじょうぶですよ。', pt: 'Pode, sim.' },
        { speaker: 'ディアンティ', ja: 'ありがとうございます。じゃあ、{火曜日|かようび}に、また{来|き}ます。', pt: 'Obrigada. Então volto na terça-feira.' },
        { speaker: '担当の人', ja: 'あと、ほかにも、{外国|がいこく}の{方|かた}のために、いろいろなサービスがあります。{説明|せつめい}しましょうか？', pt: 'Além disso, há vários outros serviços para estrangeiros. Quer que eu explique?' },
        { speaker: 'ディアンティ', ja: 'え、そうですか。じゃあ、お{願|ねが}いします。', pt: 'Ah, é? Então, por favor.' },
        { speaker: '担当の人', ja: 'このガイドブックは{見|み}たことがありますか？　{生活|せいかつ}のためのいろいろな{情報|じょうほう}を、{外国語|がいこくご}で{紹介|しょうかい}しています。インドネシア{語|ご}もありますよ。どうぞ、お{持|も}ちください。', pt: 'Você já viu este guia? Ele traz várias informações para a vida diária, em língua estrangeira. Tem em indonésio também. Pode levar.' },
        { speaker: 'ディアンティ', ja: 'ありがとうございます。へー、いいですね。', pt: 'Obrigada. Nossa, que bom.' },
        { speaker: '担当の人', ja: 'それから、ここに{書|か}いてありますが、{病気|びょうき}やけがで{病院|びょういん}に{行|い}くときのために、{外国語|がいこくご}の{通訳|つうやく}を{紹介|しょうかい}しています。こちらは{有料|ゆうりょう}ですが、とても{安|やす}く{利用|りよう}できます。', pt: 'E, como está escrito aqui, indicamos intérpretes em língua estrangeira para quando você precisa ir ao hospital por doença ou ferimento. Este serviço é pago, mas dá para usar bem barato.' },
        { speaker: 'ディアンティ', ja: 'そうですか。{助|たす}かりますね。でも、{日本|にほん}でもっと{楽|らく}に{暮|く}らせるように、もっと{日本語|にほんご}を{勉強|べんきょう}したいです。', pt: 'Ah, sei. Isso ajuda muito. Mas, para viver com mais facilidade no Japão, eu quero estudar mais japonês.' },
        { speaker: '担当の人', ja: 'あ、このセンターにも、{日本語|にほんご}{教室|きょうしつ}がありますよ。{入門|にゅうもん}から{上級|じょうきゅう}まで、たくさんのクラスがあります。{個人|こじん}レッスンがいいときは、{先生|せんせい}の{紹介|しょうかい}もしています。こちらが{案内|あんない}のパンフレットです。よろしければ、どうぞ。', pt: 'Ah, neste centro também há aulas de japonês. Temos muitas turmas, do iniciante ao avançado. Se preferir aula particular, também indicamos professores. Este é o folheto informativo. Se quiser, pode pegar.' },
        { speaker: 'ディアンティ', ja: 'ありがとうございます。', pt: 'Muito obrigada.' },
      ],
    },
  ],
}
