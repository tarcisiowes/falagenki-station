...
const reading: Section = {
  ...
  groups: [
    ...
    },
    {
      ...
      questions: [
        { id: 'n5-reading-32', number: 32, context: 'パブロさんは {高木大学|たかぎだいがく}に {行|い}きたいです。{花田駅|はなだえき}か {糸川駅|いとかわえき}から {乗|の}ります。{駅|えき}から {大学|だいがく}まで かかる お{金|かね}は 500{円|えん}までで、{時間|じかん}は みじかいほうが いいです。\n\n【{高木大学|たかぎだいがく}に {来|き}たい {人|ひと}へ】\n① かかる {時間|じかん}：46{分|ぷん}　かかる お{金|かね}：300{円|えん}\n{寺西駅|てらにしえき} バスてい 1ばん → バス 45{分|ふん} → バスてい「{高木大学前|たかぎだいがくまえ}」→ {歩|ある}く 1{分|ぷん} → {高木大学|たかぎだいがく}\n\n② かかる {時間|じかん}：30{分|ぷん}　かかる お{金|かね}：550{円|えん}\n{花田駅|はなだえき} → {電車|でんしゃ} 25{分|ふん} → {水村駅|みずむらえき} → {歩|ある}く 5{分|ふん} → {高木大学|たかぎだいがく}\n\n③ かかる {時間|じかん}：40{分|ぷん}　かかる お{金|かね}：450{円|えん}\n{花田駅|はなだえき} → ちかてつ 30{分|ぷん} → {木山駅|きやまえき} → {歩|ある}く 10{分|ぷん} → {高木大学|たかぎだいがく}\n\n④ かかる {時間|じかん}：35{分|ふん}　かかる お{金|かね}：430{円|えん}\n{糸川駅|いとかわえき} → {電車|でんしゃ} 25{分|ふん} → {木山駅|きやまえき} → {歩|ある}く 10{分|ぷん} → {高木大学|たかぎだいがく}', prompt: 'パブロさんは どの {行|い}き{方|かた}で {行|い}きますか。', choices: [{ n: 1, text: '①（46{分|ぷん}・300{円|えん}）' }, { n: 2, text: '②（30{分|ぷん}・550{円|えん}）' }, { n: 3, text: '③（40{分|ぷん}・450{円|えん}）' }, { n: 4, text: '④（35{分|ぷん}・430{円|えん}）' }], answer: 4, translationPt: 'Qual trajeto Paburo escolhe?', explanationPt: 'Condição: até 500円 → elimina ② (550円). Entre ①(46min), ③(40min) e ④(35min), o mais rápido é ④ (35min, 430円).' },
      ],
    },
  ],
}
